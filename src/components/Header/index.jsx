...
const Header = () => {
  // useSelector ile  reducderdaki statelere eris
    ...
    <header className="shadow">
      <div className="max-w-[1440px] mx-auto p-5 lg:p-8 flex items-center justify-between">
        ...
        <div className="flex gap-5">
          ...
          <button className="border py-1 rounded  text-red-500 p-3 hover:bg-red-400 hover:text-white transition max-md:hidden">
            Giris Yap
          </button>
          <button className="border py-1 rounded  text-red-500 p-3 hover:bg-red-400 hover:text-white transition max-md:hidden">
            Kaydol
